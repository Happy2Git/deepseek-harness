...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-context-files': { kind: 'none', reason: 'Browser-side UI panel reading existing session facts; registers nothing model-facing.' },
  ...
  'packages/host/directory-routes': { kind: 'none', reason: 'The GUI-host directory-browsing HTTP routes register nothing model-facing.' },
  'packages/host/git': { kind: 'none', reason: 'The GUI-host read-only git seam registers nothing model-facing.' },
  'packages/host/git-local': { kind: 'none', reason: 'The GUI-host git backend registers nothing model-facing.' },
